...
await mkdir('.backups.local/2026-09-21-dia10', { recursive: true });
const artifact = await zip.generateAsync({ type: 'nodebuffer', compression: 'DEFLATE' });
const artifactPath = '.backups.local/2026-09-21-dia10/plan-ots-candidate.zip';
...
await writeFile('docs/estabilizacion-2026-09-20/dia-10/candidate.json', JSON.stringify(report, null, 2) + '\n');
