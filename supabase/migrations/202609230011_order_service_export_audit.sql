...
begin
 ...
 if p_tipo is null or p_tipo not in ('ficha','orden_servicio','relevamiento','avance','cierre','acta') or p_formato is null or p_formato not in ('HTML','PDF') or p_solicitud is null then
