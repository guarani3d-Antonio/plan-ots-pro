...
|---|---|---|
| 1 | `vista-1.png` | Origen del pedido, reclamo recibido, evidencia del cliente y apertura de la orden de servicio. |
...
Verificación de esta ronda: los cinco PDF se generaron en A4; se renderizaron a PNG y se inspeccionó el conjunto y las páginas de orden de servicio y acta a tamaño original. El generador comprueba que el contenido permanezca por encima del pie. Se comprobó extracción de texto y número de páginas. La revisión de BBC sobre políticas y textos oficiales sigue pendiente; este mockup no afirma cumplir por sí solo un procedimiento ISO.
