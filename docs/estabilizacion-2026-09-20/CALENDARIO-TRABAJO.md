...
| **10** | Regresión final, repetición de aislamiento, restore, despliegue controlado y guion de prueba de campo. | **Revisión técnica y candidata local preparadas; NO-GO de publicación:** 138/138 controles locales, 48/48 remotos, recuperación local y mitigación PDF. Pendientes: confirmar revocación de claves expuestas, desplegar/verificar y completar Samsung física/PWA/dos dispositivos. Ver [informe](dia-10/INFORME.md). |

## Después del día 10

Prioridad de interfaz solicitada: ventana dedicada para las fotos del Panel OT, con mejor distribución, miniaturas claras y acciones Cámara/Galería. Implementación con Sol alto, manteniendo borradores, permisos y validación de evidencias. El diseño del siguiente bloque está en el informe del día 10.
